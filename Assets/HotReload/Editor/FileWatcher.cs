...
namespace ScriptHotReload
{
    ...
    public class FileWatcher
    {
        ...
        public static bool changedSinceLastGet { get; private set; }
        public static DateTime lastModifyTime { get; private set; }
        ...
        public static string[] GetChangedFile()
        {
            ...
            for(int i = 0, imax = ret.Count; i < imax; i++)
            {
                ...
                ret[i] = string.Format("{0}:{1}", filePath, Path.GetFileNameWithoutExtension(assName));
            }
        ...
        private static void OnFileChanged(object source, FileSystemEventArgs e)
        {
            ...
            {
                FileEntry entry;
                if (!_filesChanged.TryGetValue(filePath, out entry))
                {
